...
class PublicApiTestPaginationHelpersEndpoints < Grape::API
  helpers PublicApi::Helpers::PaginationHelpers
  ...
  namespace :test do
    ...
    get :paginate_users do
      ...
      present paginated_data, with: PublicApi::Entities::V2::PaginatedEntity
    end
  end
end
...
RSpec.describe PublicApi::Helpers::PaginationHelpers do
